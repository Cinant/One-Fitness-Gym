		...
		<div class="Title"><p>Mostrando <%= koperson.size() %> tipos de Persona</p></div>
			...
			<div ><p>Nombre</p></div>
				...
				<%for( KindOfPerson c : koperson ) {%>
					...
					<p><%= c.getName() %></p>1--
					<%= c.getId() %>
					<%= c.getPermision().toString() %>
					<% for(Link l : c.getPermision()){System.out.println("----------");
						
						System.out.println(l.getKind());
						System.out.println(l.getName());
						System.out.println(l.getId());
						System.out.println(l.isC());
						System.out.println(l.isR());
						System.out.println(l.isU());
						System.out.println(l.isD());
						System.out.println(l.isCanI());}%>
